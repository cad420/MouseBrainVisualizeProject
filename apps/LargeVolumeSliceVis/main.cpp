...
//    transferFunctionExt1D.points.emplace_back(0.f,Vector4f{0.f,0.f,0.f,0.f});
//    transferFunctionExt1D.points.emplace_back(1.f,Vector4f{1.f,1.f,1.f,1.f});
    ...
    slice_renderer->setTransferFunction(transferFunctionExt1D);
